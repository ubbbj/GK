...
public class SceneGraph extends JPanel {
    ...
    private void createWorld() {
        ...
        //figura 1
        polygon1 = new TransformedObject(gPentagon);
        polygon1.setTranslation(-1,0);
        world.add(polygon1);
        polygon2 = new TransformedObject(gPentagon);
        ...
        //figura 2
        polygon3 = new TransformedObject(gPentagon);
        polygon3.setTranslation(-1.42,1.5).setScale(0.8,0.8);
        world.add(polygon3);
        polygon4 = new TransformedObject(gPentagon);
        ...
        //figura 3
        polygon5 = new TransformedObject(gPentagon);
        polygon5.setTranslation(1.42,2.02).setScale(0.6,0.6);
        world.add(polygon5);
        polygon6 = new TransformedObject(gPentagon);
    ...
    private static SceneGraphNode gPentagon = new SceneGraphNode() {
        void doDraw(Graphics2D g) {
            int n = 5;
            int[] x = new int[n];
            int[] y = new int[n];
